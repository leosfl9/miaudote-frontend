            ...
            <form onSubmit={handleSubmit(onSubmit)} className="bg-white flex flex-col gap-3 items-center w-full max-w-4xl px-3 md:px-6 lg:px-12 py-6 rounded-4xl">
                ...
                <div className="flex flex-col w-full gap-2">
                    <div className="flex flex-col sm:flex-row gap-2 lg:gap-3">
                        <InputField label="Nome da ONG/protetor *" maxLength={100} {...register("nome")} error={errors.nome?.message} name="nome" type="text" placeholder="Digite o nome" className="mb-2" />
                    ...
                    <div className="flex flex-col sm:flex-row gap-2 lg:gap-3">
                        ...
                        <InputField label="E-mail *" maxLength={200} {...register("email")} error={errors.email?.message} name="email" type="text" placeholder="Digite o e-mail" className="mb-2" />
                    ...
                    <div className="flex flex-col sm:flex-row gap-2 lg:gap-3">
                        ...
                        <InputField label="Site ou rede social" maxLength={255} {...register("site")} error={errors.site?.message} name="site" type="text" placeholder="Link do site ou rede social" className="mb-2" />
                    </div>
                ...
                <div className="flex flex-col w-full gap-2">
                    ...
                    <div className="flex flex-col sm:flex-row gap-2 lg:gap-3">
                        ...
                        <InputField label="Número *" maxLength={10} {...register("numero")} error={errors.numero?.message} name="numero" type="text" placeholder="Digite o número" className="mb-2" />
