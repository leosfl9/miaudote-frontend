...
export default function ConfirmacaoPage() {
  ...
  // hook para ler os parâmetros passados na url
  const searchParams = useSearchParams();
  // leitura dos parâmetors da url, obtendo o tipo do usuário recém-cadastrado
  ...
  useEffect(() => {
    // obtém do sessionStorage o estado de recém-cadastro
    const flag = sessionStorage.getItem("justRegistered");
    // se o usuário não for recém-cadastrado, envia-o para a página de tipo de cadastro
