...
export default function TipoCadastro() {
  return (
    <div className="flex flex-col gap-10 sm:gap-8 px-3 md:px-8 items-center justify-center min-h-screen py-8 bg-[url('/grafo_fundo.png')] bg-no-repeat bg-cover bg-center">
