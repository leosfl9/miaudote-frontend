...
export default function HomeParceiro(){
    ...
    return (
        <div className="flex flex-col gap-6 px-4 sm:px-16 md:px-20 lg:px-30 py-4 sm:py-8 lg:py-10 ">
            ...
            <div className="flex flex-col lg:flex-row lg:flex-wrap gap-3 lg:gap-4 mxl:!gap-8 items-center lg:items-start justify-center">
                ...
                {animais.length > 0 ? (
                  ...
                  <div className="py-8 px-0 flex flex-col gap-6 text-start text-text-light-gray font-medium text-2xl">
                    <div className="space-y-2 sm:space-y-0">
                      ...
                      <p>Que tal cadastrar seu primeiro pet?</p>
                    </div>
                  </div>
                )}
            </div>
